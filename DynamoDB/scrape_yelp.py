...
# Yelp API Key
#import secrets
API_KEY = "VDD0z6MZ9-JdmBjaMPYpSziTeDuwSS33HIpKLIVii9ajkdca" \
          "FbJV-YBA1ypMW2qqxKwy5p-4qCWNsLFD2ceKuHDWrsSLUYOPJy2WUV-I0" \
          "eThvgjCjW-2uoOpv0YiYHYx"
...
def main():
    """Scrape 5000+ restaurants from Yelp in 7 cuisine types:
    ...
    # save to json file
    save_file = '../RestData/businesses_raw_2.json'
